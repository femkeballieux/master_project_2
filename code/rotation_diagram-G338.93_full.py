...
#Lines and regions
path = '/net/vdesk/data2/bach1/ballieux/master_project_2/data/high_mass_data/G338.93/'
lines = ['CO21','CO32']
regions= ['redshifted_outflow_1', 'redshifted_outflow_2', 'redshifted_outflow_3', 'blueshifted_outflow_1']
pixel_region_size_21 = [4.247e3, 1.555e3, 1.15e2, 1.8685e4] #The region size in pixels
pixel_region_size_32 = [5.376e3, 1.961e3, 1.46e2, 2.036e4] #Important to do them seperately, as some regions get cut off
...
for i, region in enumerate(regions): 
    ...
    for line in lines:
        ...
        e_integral = 0.1 * integral #TODO: uncertainty in trapz?
